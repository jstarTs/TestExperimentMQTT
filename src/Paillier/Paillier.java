...
public class Paillier {
	...
	*/
	...
	//
	public Paillier(boolean isEncryption) {
		KeyGeneration(512, 64);
		if(true)
		{
	...
	*/
	public static void main(String[] str) {
		...
		/* encryption*/
		BigInteger em1 = paillier1.Encryption(m1);
		BigInteger em2 = paillier1.Encryption(m2);
		BigInteger em3 = paillier1.Encryption(m3);
		...
		BigInteger product_em1em2 = em1.multiply(em2).multiply(em3).mod(paillier.nsquare);
		BigInteger sum_m1m2 = m1.add(m2).add(m3).mod(paillier.n);
