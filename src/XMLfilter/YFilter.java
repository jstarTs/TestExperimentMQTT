 ...
 */
public class YFilter implements InterfaceOfYFilter {
	...
	/* (non-Javadoc)
	 * @see XMLfilter.InterfaceOfYFilter#init()
	 */
	@Override
	public void init()
	{
	...
	/* (non-Javadoc)
	 * @see XMLfilter.InterfaceOfYFilter#reset()
	 */
	@Override
	public void reset() {
		Set<Integer> mySet = new HashSet<Integer>();
	...
	protected void ReadElement(Set<Integer> currentSet, String elementName, Integer stateNumber) {
		...
		Integer obj = null;
		if( (obj = tmpIndexNode.currentHashTable.get(elementName)) != null ||
			(obj = tmpIndexNode.currentHashTable.get("*")) != null) {
			currentSet.add(obj);
		}
	...
	/* (non-Javadoc)
	 * @see XMLfilter.InterfaceOfYFilter#ReadElement(java.lang.String)
	 */
	@Override
	public void ReadElement(String elementName) {
		...
		for(Integer currentID: stack.peek() ) {
			...
			if((obj = tmpIndexNode.currentHashTable.get(String.valueOf(epsilon))) != null) {
				ReadElement(currentSet,elementName,obj);
			}
			/*
			for(Entry<String,Integer> entry : tmpIndexNode.currentHashTable.entrySet()) {
				// Step 1: Check element name existed or not.
	...
	/* (non-Javadoc)
	 * @see XMLfilter.InterfaceOfYFilter#AcceptedStates()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see XMLfilter.InterfaceOfYFilter#IsAccept()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see XMLfilter.InterfaceOfYFilter#PopElement()
	 */
	@Override
...
//		AcceptThenPrint(myFilter);
	...
	public static void AcceptThenPrint(InterfaceOfYFilter myFilter) {
	...
	/* (non-Javadoc)
	 * @see XMLfilter.InterfaceOfYFilter#AppendXPath(java.lang.String)
	 */
	@Override
